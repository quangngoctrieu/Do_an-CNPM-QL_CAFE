...
--Chức vụ
insert into chucvu(macv,chucvu,luong) values (N'PC',N'Pha chế',25000)
insert into chucvu(macv,chucvu,luong) values (N'PV',N'Phục vụ',20000)
insert into chucvu(macv,chucvu,luong) values (N'QL',N'Quản lý',40000)
insert into chucvu(macv,chucvu,luong) values (N'AD',N'Admin',0)
--Ca làm
...
--Khachhang
insert into khachhang(makh,hokh,tenkh,gioitinh,ngaysinh,sodienthoai,ngaytaothanhvien,diemtichluy,trangthai) values (N'KH1',N'Nguyễn',N'Phong Phú',N'Nam','18-02-2000',N'0367945523','10-10-2020',1,0)
--nhanvien
insert into nhanvien(manv,honv,tennv,gioitinh,ngaysinh,diachi,cmnd,sodienthoai,ngayvaolam,chucvu,trangthai) values (N'NV1',N'Nguyễn',N'Phong Phú',N'Nam','18-02-2000',N'A1/20Q, ấp 1, xã Vĩnh Lộc A, huyện Bình Chánh','1234567894','0367945523','10-10-2020',N'AD',1)
--taikhoan
...
--thuongnhanvien
insert into thuongnhanvien(mathuong,lydothuong,mucthuong) values (N'MT1',N'Doanh thu trên 10tr',200000)
--luong
--lương lấy lương cb ở chức vụ nhân cho số giờ là được tổng kết ở bảng giờ làm
insert into luong(manv,mathuong,tonggiolam,tienluong,trangthai) values (N'NV1',N'MT1',0,0,0)
--phieunhap
...
--uudai
insert into uudai(maud,tenu,dieukienud,tiengiam,trangthai) values (N'UD1',N'Đồng',10,2,0)
--hoadon
